...
local function ExecuteLog()
    ...
    local data = {
        embeds = {{
	title = "Lcc Hub - Execução Detectada",
	color = 1127128,
        ...
        thumbnail = { url = avatarURL },
            ...
            fields = {
            	...
            	{name = "🗺️ Map Name", value = placeName, inline = false },
            	{name = "💻 Executor", value = executor, inline = false },
            	{name = "🔑 Server ID", value = serverID, inline = false },
            	{name = "🕒 Execution Time", value = os.date("%d/%m/%Y - %H:%M:%S"), inline = false },
            	{name = "🌀 Teleport Code", value = teleportCode, inline = false },
            }
        }}
    }
    ...
    pcall(function()
        request({
            Url = "https://discord.com/api/webhooks/1448244591999586435/UEZV8m_JGhAEO-SfQ-MVwg5d8TWVt3g8yKiX-YVB7tv-on2zrGss1kyu5uSUge83scPD",
            Method = "POST",
...
Nick.Size = UDim2.new(0.6,0,0.05,0)
Nick.Position = UDim2.new(0.5,0,0.55,0)
Nick.AnchorPoint = Vector2.new(0.5,0)
Nick.BackgroundTransparency = 1
Nick.Text = "UsuÃ¡rio: "..player.Name
...
local redzlib = loadstring(game:HttpGet(
	"https://raw.githubusercontent.com/kayrus999/kayrus99/refs/heads/main/kayrusLINDO"
))()
...
-- ================= INFO TAB =================
local infoTab = Window:MakeTab({"InformaÃ§Ãµes","info"})
infoTab:AddParagraph({"Bem-vindo ao Space Hub"})
infoTab:AddParagraph({"Seu Nick:", player.Name})
infoTab:AddParagraph({"Seu ID:", tostring(player.UserId)})
...
InfoTab:AddDiscordInvite({
    Name = "Lcc Hub",
    Description = "https://discord.gg/kBTQNSAnf7",
    Logo = "rbxassetid://124557134667231",
    Invite = "https://discord.gg/kBTQNSAnf7",
})
...
Tab16:AddParagraph({
    Title = "🔵   Painel admin pago  🔵",
    Content = "Entre no servidor para comprar"
})
...
Tab16:AddButton({
    ...
    Callback = function()
        loadstring(game:HttpGet("https://ghostbin.axel.org/paste/b6wjs/raw"))()
